...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <article className="mx-auto w-full min-w-0 max-w-3xl">
      <ReadingProgress />
      <div className="article-prose prose max-w-none min-w-0 prose-headings:font-display prose-headings:font-normal prose-headings:tracking-tight prose-a:text-accent prose-a:decoration-accent/40 prose-a:underline-offset-4 prose-strong:text-foreground prose-img:border prose-img:border-border prose-hr:border-border prose-blockquote:border-l-accent/50">
        <BlogArticleHeader
          title={postData.title}
          dateLabel={dateLabel}
