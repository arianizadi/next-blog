...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <article className="mx-auto w-full min-w-0 max-w-3xl">
      <ReadingProgress />
      <div className="article-prose prose max-w-none min-w-0 pt-16 prose-headings:font-display prose-headings:uppercase prose-a:text-accent-ink prose-a:decoration-accent/40 prose-strong:text-foreground prose-code:text-accent-ink prose-img:border prose-img:border-border">
        <BlogArticleHeader
          title={postData.title}
          dateLabel={dateLabel}
